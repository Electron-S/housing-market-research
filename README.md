...
재개발·재건축 사업지 시장조사 및 적정분양가 검토를 위한 리서치 워크스페이스다. [KCS-AI](https://github.com/gaebalai/KCS-AI) 건설경영 제안서 파이프라인을 기반으로, 한국 부동산 분양 시장에 특화된 15단계 분석·집필 파이프라인으로 재구성했다. 기본 사용자는 GS건설 실무 담당자를 상정하며, 보고서에는 GS건설 입장에서의 경쟁사 비교분석과 대응 시사점을 포함한다. 사업구역이 특정되면 해당 구역에서 GS건설이 추진 중이거나 검토 중인 사업 내용을 먼저 확인한 뒤 본 분석에 들어간다.
